<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="通告状态" prop="tonggaozhuangtai">
					<el-input v-model="ruleForm.tonggaozhuangtai" placeholder="通告状态" clearable  :readonly="ro.tonggaozhuangtai"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else class="input" label="通告状态" prop="tonggaozhuangtai">
					<el-input v-model="ruleForm.tonggaozhuangtai" placeholder="通告状态" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tonggaozhuangtai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tonggaozhuangtaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
