	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="商家简介" prop="shangjiajianjie">
					<el-input v-model="ruleForm.shangjiajianjie" placeholder="商家简介" clearable  :readonly="ro.shangjiajianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else class="input" label="商家简介" prop="shangjiajianjie">
					<el-input v-model="ruleForm.shangjiajianjie" placeholder="商家简介" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				shangjianicheng: [
					{ required: true, message: '商家昵称不能为空', trigger: 'blur' },
				],
				mima: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shangjiajianjie'){
							this.ruleForm.shangjiajianjie = obj[o];
							this.ro.shangjiajianjie = true;
							continue;
						}
						if(o=='lianxifangshi'){
