	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="通告类型" prop="tonggaoleixing">
					<el-select :disabled="ro.tonggaoleixing" v-model="ruleForm.tonggaoleixing" placeholder="请选择通告类型" >
						<el-option
							v-for="(item,index) in tonggaoleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else class="input" label="通告类型" prop="tonggaoleixing">
					<el-input v-model="ruleForm.tonggaoleixing"
						placeholder="通告类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="通告状态" prop="tonggaozhuangtai">
					<el-select :disabled="ro.tonggaozhuangtai" v-model="ruleForm.tonggaozhuangtai" placeholder="请选择通告状态" >
						<el-option
							v-for="(item,index) in tonggaozhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' v-else class="input" label="通告状态" prop="tonggaozhuangtai">
					<el-input v-model="ruleForm.tonggaozhuangtai"
						placeholder="通告状态" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="拍摄时间" prop="paisheshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.paisheshijian" label="拍摄时间" prop="paisheshijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="upload" v-if="type!='info' && !ro.tonggaofengmian" label="通告封面" prop="tonggaofengmian">
					<file-upload
						tip="点击上传通告封面"
						action="file/upload"
						:limit="3"
						:multiple="true"
						:fileUrls="ruleForm.tonggaofengmian?ruleForm.tonggaofengmian:''"
						@change="tonggaofengmianUploadChange"
					></file-upload>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="upload" v-else-if="ruleForm.tonggaofengmian" label="通告封面" prop="tonggaofengmian">
					<img v-if="ruleForm.tonggaofengmian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.tonggaofengmian.split(',')[0]" width="100" height="100">
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tonggaofengmian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="发布时间" prop="fabushijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
				...
				<el-form-item :style='{"margin":"0 0 20px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"48%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tonggaofengmian'){
							this.ruleForm.tonggaofengmian = obj[o];
            ...
            this.$http({
				url: `option/tonggaozhuangtai/tonggaozhuangtai`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.tonggaozhuangtaiOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
	...
	if(this.ruleForm.tonggaofengmian!=null) {
		this.ruleForm.tonggaofengmian = this.ruleForm.tonggaofengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tonggao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tonggaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    tonggaofengmianUploadChange(fileUrls) {
	    this.ruleForm.tonggaofengmian = fileUrls;
    },
  }
};
</script>
